...
class Variable_in_Code_List:
    ...
    def Append(self,Num,GlobalDict,LocalDict):
        GlobalDict = M_264910_copy.deepcopy(OnlyUse(GlobalDict))
        LocalDict = M_264910_copy.deepcopy(OnlyUse(LocalDict))
